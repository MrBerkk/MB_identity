...
Config.PlasticSurgeryUnits = {
    vector3(356.61, -601.82, 42.28),      -- Central Los Santos Medical Center
   -- vector3(1835.29, 3677.77, 34.27),     -- Los Santos General Hospital (Coroner)
...
Config.NewIdentityProviders = {
   ...
   -- vector3(-544.9, -204.4, 37.5),      -- Rockford Hills City Hall
    ...
    -- vector3(-1283.4, -565.1, 31.0)   -- Del Perro City Hall
      vector3(456.86, -972.33, 35.3) -- LSPD NEW IDENTITY
}
